...
and sources of delay in the transition from data collection to data analysis. The [Leek group](http://jtleek.com/) works with a large
...
1. The raw data.
2. A tidy data set `r citep(bib[['tidyr']])`
...
The general principles of tidy data are laid out by [Hadley Wickham](http://had.co.nz/) in his _Tidy Data_ paper `r citep(bib[['tidyr']])`
and [this video](http://vimeo.com/33727555). The paper and the video are both focused on the [R](http://www.r-project.org/) `r citep(bib[['R']])` package, which you
...
You may have heard this before, but [reproducibility is kind of a big deal in computational science](http://www.sciencemag.org/content/334/6060/1226) `r citep(bib[['reproducibility']])`.
...
* [Jeff Leek](http://jtleek.com/) - Wrote the initial version.
* [L. Collado-Torres](http://bit.ly/LColladoTorres) - Fixed typos, added links, used `knitrBootstrap` `r citep(bib[['knitrBootstrap']])` to format the page.
